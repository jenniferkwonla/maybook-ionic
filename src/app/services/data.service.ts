...
import { BookStackData } from '../data/book-stack-data';
...
export class DataService {
  ...
  getBookStack(): Promise<BookStackData[]>{
    ...
    let result: BookStackData[] = [];

    return this.sendBookGetBookStackRequestToExpress(this.baseUrl+"/"+"book"+"/"+"stack"+"/"+maxBooksToProcess+"/", maxBooksToProcess).then((data) => {
  ...
  getBookInLibraryByUserId(): Promise<string[]>{
    ...
    return this.sendLibraryGetLibraryByUserIdToExpress(this.baseUrl + "/"+"library"+ "/"+this.userid+"/").then((data) => {
  ...
  getLogin(userid: string, password: string): Promise<AccountData[]>{
    this.userid = userid;
    return this.sendAccountGetLoginRequestToExpress(this.baseUrl + "/" + "account" + "/" + userid + "/"+ password +"/", userid, password).then((data) => {
      return data;
    });
  }
  ...
  private sendLibraryGetLibraryByUserIdToExpress(endpoint:string):Promise<any>{
    ...
    this.httpOptions.parameters.append("userid", this.userid);
  ...
  private sendLibraryPostLovedBooksRequestToExpress(endpoint:string, books: string[]):Promise<any>{
    ...
    let jsonData = {"love": {"userid": this.userid,"books": booksString}};
    let data;
    let options= {
      url: endpoint,
      data: jsonData,
  ...
  private sendBookGetBookStackRequestToExpress(endpoint: string, maxBooksToProcess: number):Promise<any>{
    this.httpOptions.parameters = new HttpParams();
